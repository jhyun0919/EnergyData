...
from Preprocess import refining_data
...
class Model:
    ...
    def build_model(file_list):
        ...
        similarity_model['covariance'] = symmetric(Model.covariance_model(file_list))
        similarity_model['cosine_similarity'] = symmetric(Model.cosine_similarity_model(file_list))
        similarity_model['euclidean_distance'] = symmetric(Model.euclidean_distance_model(file_list))
        similarity_model['manhattan_distance'] = symmetric(Model.manhattan_distance_model(file_list))
        similarity_model['gradient_similarity'] = symmetric(Model.gradient_similarity_model(file_list))
