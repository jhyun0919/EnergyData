...
* Based on sensor data analysing results, it will provide you a chance to **detect abnormal energy consuming behavior**, which is a main reason of wasting power.
* 
